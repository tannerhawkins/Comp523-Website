      ...
      <header>
        <div className="title">
          ...
          <p>
            ...
            project carries the important message of the Gospel: that Jesus Christ, 
            the Son of God, took upon flesh and came down from heaven to reunite 
            us with him by taking upon our punishment of death, thus ultimately 
            defeating sin through dying on the cross. This message is important 
            to all, including children. The primary goals of the Ancient Path 
            Adventures AR Education Aid is to produce a website that will connect 
            the books APA creates with their online quizzes and videos. The web 
            app, based on subscription tier, will also allow teachers to create/modify 
            their own modules to cater the content towards their needs.
          </p>
        </div>
      </header>
      <div className="title">
