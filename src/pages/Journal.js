...
const NewlineText = (props) => {
  ...
  const newText = text
    .split("\r\n")
    .map((str) => <p style={{ display: shown ? "block" : "none" }}>{str}</p>);
...
const Journal = () => (
  <Main description={"Journal of meetings and meeting schedule"}>
    <article className="post" id="index">
      <header>
        <div className="title">
          <h2 data-testid="heading" href={`#schedule`}>
            Schedule
          </h2>
          <p>
            Tuesdays 4:30pm: Client Meeting on Zoom
            <br />
            Wednesdays 10:00am: Mentor Meeting in Discord
            <br />
            Wednesdays 2:45pm: Team Meeting in Sitterson Lobby
            <br />
          </p>
        </div>
      </header>
      <header>
        <div className="title">
          <h2 data-testid="heading" href={`#journal`}>
            Journal
          </h2>
